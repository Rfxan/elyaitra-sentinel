...
const BlockMap = ({ blockedIPs, geoDataMap = {}, newlyBlocked = new Set() }) => {
  return (
    <div className="relative w-full h-full min-h-[300px] bg-[#1A1F2B] overflow-hidden flex items-center justify-center rounded-2xl border border-white/10 p-4">
      <div 
